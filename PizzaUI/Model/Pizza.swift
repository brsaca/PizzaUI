...
extension Pizza {
    static let MOCK_PIZZAS = [
        Pizza(name: "Pepperoni Blast", image: "pepperoni", details:
        ...
        Pizza(name: "Shrimptastic", image: "shrimptastic", details:
        ...
        Pizza(name: "Midnight Harvest", image: "midnight", details:
